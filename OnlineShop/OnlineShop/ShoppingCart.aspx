					...
					<Columns>
						<asp:TemplateField HeaderText="Tên Sản Phẩm">
							<ItemTemplate>
								...
								<br />
								<asp:Label ID="idPro" runat="server" Text='<%# Eval("ProductId") %>'></asp:Label>
							</ItemTemplate>
						</asp:TemplateField>
						...
						<asp:TemplateField HeaderText="Sửa" ShowHeader="False">
							...
							<ItemTemplate>
								<asp:LinkButton ID="btn_Sua" runat="server" CommandArgument='<%# Eval("ProductId") %>' onClick="btn_Sua_Click">Update</asp:LinkButton>
							</ItemTemplate>
						</asp:TemplateField>
						<asp:TemplateField HeaderText="" ShowHeader="False">
							<ItemTemplate>
								<asp:LinkButton ID="lbDelete" runat="server" OnClientClick="return confirm('Bạn muốn xóa sản phẩm này khỏi giỏ hàng?')" CausesValidation="False" CommandName="Delete" Text="Delete"></asp:LinkButton>
							</ItemTemplate>
						</asp:TemplateField>
					</Columns>
					<EmptyDataTemplate>
