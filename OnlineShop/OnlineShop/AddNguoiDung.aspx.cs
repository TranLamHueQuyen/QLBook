	...
	public partial class AddNguoiDung : System.Web.UI.Page
	{
		...
		protected void btnAddUser_Click(object sender, EventArgs e)
		{
			if (ktData())
			{
				...
				{
					string sql = "insert into Product(Username, Email, RoleId, Password, CreateDate, Status) values(N'" + username.Text + "', '" + email.Text + "', '" + ddRoles.SelectedValue + "', '" + pasword.Text + "', GETDATE(),N'" + status.Text + "')";
					Response.Write(sql);
